...
class Guard:
    ...
    def most_sleep_minute(self):
        return self.sleep_data.index(max(self.sleep_data))
...
max_guard = max(guards.values(), key=lambda guard: guard.total_sleep)
print(f'Guard: {max_guard.id}, Most Sleep: {max_guard.most_sleep_minute}')
print(f'{max_guard.id * max_guard.most_sleep_minute}')
